...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_HandTracking p_HandTracking;
        ...
        public static SteamVR_Input_ActionSet_HandTracking HandTracking
        {
            get
            {
                return SteamVR_Actions.p_HandTracking.GetCopy<SteamVR_Input_ActionSet_HandTracking>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_HandTracking = ((SteamVR_Input_ActionSet_HandTracking)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_HandTracking>("/actions/HandTracking")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.HandTracking};
        }
    }
}
